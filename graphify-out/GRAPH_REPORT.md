...
## Corpus Check
- 244 files · ~392,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2926 nodes · 5416 edges · 171 communities (156 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 181 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd759cec`
...
Cohesion: 0.02
Nodes (78): anonymousSessionsRef, firestore, publicHttpOptions, accountSessionsRef, allowedPhotoMimeTypes, AppData, appDataRef, CalendarEvent (+70 more)
...
Cohesion: 0.08
Nodes (78): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), _compute_taste_embedding(), embed_unembedded_recipes(), _parse_embedding(), Recompute a user's taste embedding *and* ability profile (issue #59).      Pulls, recompute_all_user_embeddings() (+70 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (62): icsSubscriptionHints, GoogleIcon(), MicrosoftIcon(), IngredientEditor(), ChoiceGroup(), AccountMessageTone, AccountProviderId, AccountSummary (+54 more)
...
Cohesion: 0.07
Nodes (39): ALLERGEN_DISPLAY, ALLERGEN_ICONS, allergenIcon(), AllergenTag(), ConfirmDialog(), AppButton(), Badge(), RecipeEditorOutput (+31 more)
...
Cohesion: 0.11
Nodes (22): ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), deadlineToContextEvent(), fetchDeadlineContext() (+14 more)
...
Cohesion: 0.15
Nodes (22): appButtonClasses, AppButtonVariant, badgeTones, Field(), sanitiseNumericInput(), SelectField(), Tone, UniversityField() (+14 more)
...
Cohesion: 0.11
Nodes (24): clamp(), countableUnits, formatQuantityForInput(), INGREDIENT_DENSITY_G_PER_ML, ingredientAliases, ingredientOptions, ingredientPreparations, ingredientSearchTerm() (+16 more)
...
Cohesion: 0.15
Nodes (25): asRecord(), boundedNumber(), boundedString(), boundedStringList(), normalizeDeadline(), readRequestBody(), callRecommenderJson(), canonicalRecommenderTags() (+17 more)
...
Cohesion: 0.13
Nodes (16): ITEM_WEIGHT_G, aggregationUnit(), ALL_PREP_WORDS, ALWAYS_AVAILABLE, COUNT_LIKE_UNITS, extractIngredientParts(), MASS_TO_G, NON_PLURAL_S (+8 more)
...
Cohesion: 0.16
Nodes (13): defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber() (+5 more)
...
Cohesion: 0.25
Nodes (7): formatIngredient(), parseIngredients(), pluraliseUnit(), [flour], ingredients, [salt], [sugar]
...
## Knowledge Gaps
- **1126 isolated node(s):** `database`, `location`, `rules`, `indexes`, `rules` (+1121 more)
...
- **Why does `RecipeIngredient` connect `Community 6` to `Community 35`, `Community 70`, `Community 7`, `Community 13`, `Community 51`, `Community 87`, `Community 56`, `Community 25`, `Community 27`, `Community 60`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 60` to `Community 36`, `Community 61`, `Community 87`, `Community 63`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Ingredient` connect `Community 15` to `Community 12`, `Community 60`, `Community 63`?**
