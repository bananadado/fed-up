...
## Corpus Check
- 137 files · ~77,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1351 nodes · 2360 edges · 97 communities (82 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `956b5d28`
...
Cohesion: 0.11
Nodes (30): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), parseICSText(), unfoldLines(), calendarEventsToDeadlines(), base64UrlEncode() (+22 more)
...
Cohesion: 0.18
Nodes (8): Shell(), initialPlan, onboardingScreens, screens, Screen, formatCookingLimit(), Onboarding(), SettingsScreen()
...
Cohesion: 0.10
Nodes (31): IngredientEditor(), clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, IngredientDraft (+23 more)

### Community 35 - "Community 35"
Cohesion: 0.17
Nodes (24): BudgetCard(), AppButton(), Badge(), TrackPrototypeEvent, seedMeals, mealHealthSignals(), vegetableWords, weeklyBalanceSummary() (+16 more)
...
Cohesion: 0.18
Nodes (13): Field(), RecipeIngredient, ingredientDraftsFromIngredients(), fetchOpenFoodFactsNutrition(), MealType, Nutrition, NutritionSource, PlanMeal (+5 more)
...
## Knowledge Gaps
- **630 isolated node(s):** `Runtime`, `Stack`, `1. Active Prototype (what users see)`, `2. Dormant React Router Slice (not mounted)`, `code:sh (bun run lint                 # ESLint)` (+625 more)
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.08639435791948281 - nodes in this community are weakly interconnected._
