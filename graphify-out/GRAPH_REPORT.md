...
## Corpus Check
- 183 files · ~113,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1937 nodes · 3460 edges · 133 communities (112 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c5a45f4`
...
5. `Card()` - 20 edges
6. `scripts` - 19 edges
7. `sample_recipe()` - 19 edges
8. `AsyncSession` - 19 edges
9. `Development And Testing` - 18 edges
10. `extract_context()` - 17 edges

## Surprising Connections (you probably didn't know these)
- `test_score_is_clamped_between_zero_and_one()` --calls--> `score_difficulty()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_difficulty.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/difficulty.py
- `test_more_techniques_increase_difficulty()` --calls--> `score_difficulty()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_difficulty.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/difficulty.py
- `test_uncommon_equipment_increases_difficulty()` --calls--> `score_difficulty()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_difficulty.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/difficulty.py
- `test_more_ingredients_increase_difficulty()` --calls--> `score_difficulty()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_difficulty.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/difficulty.py
- `test_longer_prep_increases_difficulty()` --calls--> `score_difficulty()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_difficulty.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/difficulty.py
...
Cohesion: 0.11
Nodes (30): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), parseICSText(), IngredientEditor(), ChoiceGroup(), Field() (+22 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (71): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), embed_single(), embed_texts(), get_model(), Qualitative bucket for prep time.      Synthesized natural-language descriptions, Build the natural-language description that gets embedded.      Deliberately emp (+63 more)
...
Cohesion: 0.07
Nodes (40): firebaseFunctionUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (33): float, str, client(), fake_embed_single(), fake_embed_texts(), FakeResult, FakeSession, _Mappings (+25 more)
...
Cohesion: 0.14
Nodes (27): BudgetCard(), Badge(), mealTypeIcon, priceDiff(), slotLabels, SwapModal(), RecipeIngredient, mealSlots (+19 more)
...
Cohesion: 0.12
Nodes (23): clamp(), countableUnits, formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientName(), ingredientOptions, ingredientPreparations (+15 more)
...
Cohesion: 0.16
Nodes (15): createDeadlineModeCommands(), DeadlineModeAction, DeadlineModeCommands, DeadlineModeInternalAction, deadlineModeReducer(), DeadlineModeState, initialDeadlineModeState, withEvent() (+7 more)
...
Cohesion: 0.12
Nodes (12): RecipeEditorOutput, initialPlan, DeadlineFoodPrototype(), isAppScreen(), onboardingScreens, screens, fetchRecipeCatalogue(), setRecipeCatalogue() (+4 more)
...
Cohesion: 0.17
Nodes (11): AppButton(), defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), TAG_OPTIONS, Shell() (+3 more)

### Community 39 - "Community 39"
Cohesion: 0.21
Nodes (15): positiveNumber(), RecipeEditor(), fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl(), submitRecipeReview(), groceryVendorById() (+7 more)
...
Cohesion: 0.18
Nodes (10): strategyLabels, KitchenAccess, MealType, PlannedMeal, PlanningConstraints, PlanStrategy, RankedStrategy, RecipeDetails (+2 more)
...
## Knowledge Gaps
- **761 isolated node(s):** `indexes`, `fieldOverrides`, `database`, `location`, `rules` (+756 more)
...
- **Why does `Deadline Food Autopilot — Product and Implementation Specification` connect `Community 31` to `Community 58`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 106`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 1` to `Community 14`, `Community 6`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 15` to `Community 0`, `Community 38`, `Community 8`, `Community 43`, `Community 12`?**
