...
## Corpus Check
- 226 files · ~352,225 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2593 nodes · 4759 edges · 151 communities (134 shown, 17 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43b906ee`
...
Cohesion: 0.08
Nodes (48): BudgetCard(), entryTotal(), AppButton(), Badge(), formatPortionNote(), RecipeEditorOutput, Shell(), allSlots (+40 more)
...
Cohesion: 0.06
Nodes (45): calendarWarning, chilli, desktopNav, planDays, sessionLoaded, AnalyticsProperties, AnalyticsProperty, capturePostHogEvent() (+37 more)
...
Cohesion: 0.09
Nodes (27): ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), deadlineToContextEvent(), fetchDeadlineContext() (+19 more)
...
Cohesion: 0.09
Nodes (34): ConfirmDialog(), positiveNumber(), RecipeEditor(), currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), formatIngredient() (+26 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (36): IngredientEditor(), Field(), defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote() (+28 more)
...
Cohesion: 0.15
Nodes (22): appButtonClasses, AppButtonVariant, badgeTones, ChoiceGroup(), SelectField(), Tone, cn(), CardAction() (+14 more)
...
Cohesion: 0.10
Nodes (25): firebaseFunctionUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), exchangeCodeOnServer(), GoogleExchangeResult, importGoogleCalendar(), isGoogleConfigured() (+17 more)
...
Cohesion: 0.13
Nodes (18): initFirebase(), IngredientNutritionEstimate, OpenFoodFactsProduct, authHeaders(), bulkUpsertRecipes(), listRecipes(), RecipeOut, recommenderUrl() (+10 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (19): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), UniversityField(), allergens, calendarProviders, cookingAbilities (+11 more)
...
Cohesion: 0.19
Nodes (14): cacheKeyForName(), categoryTerms(), cookingAdjectives, estimateIngredientNutrition(), gramsForIngredient(), irregularCategoryTerms, normalizeIngredientKey(), NutritionWithSource (+6 more)
...
## Knowledge Gaps
- **998 isolated node(s):** `indexes`, `fieldOverrides`, `database`, `location`, `rules` (+993 more)
...
- **Why does `recompute_user_profile()` connect `Community 8` to `Community 14`, `Community 63`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 4` to `Community 65`, `Community 1`, `Community 27`, `Community 68`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `RecipeIngredient` connect `Community 33` to `Community 4`, `Community 11`, `Community 48`, `Community 17`, `Community 19`, `Community 20`, `Community 23`, `Community 27`?**
