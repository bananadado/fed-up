...
## Corpus Check
- 215 files · ~158,910 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2617 nodes · 4657 edges · 159 communities (134 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `481c7ede`
...
- `test_event_type_academic_vs_general()` --calls--> `event_type()`  [INFERRED]
  /home/kolesniii/uni/drp03/backend/recommender-api/tests/test_context_classify.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/context.py

## Communities (159 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (98): allowedPhotoMimeTypes, anonymousSessionsRef, calendarOAuthSecrets, ensureRecipesSeeded(), estimateIngredientNutrition(), firestore, googleClientId, googleClientSecret (+90 more)
...
Cohesion: 0.08
Nodes (38): icsSubscriptionHints, IngredientEditor(), ChoiceGroup(), calendarWarning, chilli, desktopNav, planDays, sessionLoaded (+30 more)
...
Cohesion: 0.16
Nodes (23): BudgetCard(), entryTotal(), allSlots, mealTypeIcon, priceDiff(), slotLabels, sortLabels, SortOption (+15 more)
...
Cohesion: 0.05
Nodes (76): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), score_difficulty(), embed_single(), embed_texts(), get_model(), _compute_taste_embedding() (+68 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (56): BootstrapBoundary(), createEventBus(), EventBus, appButtonClasses, AppButtonVariant, badgeTones, Field(), SelectField() (+48 more)
...
Cohesion: 0.12
Nodes (24): clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientDraftsFromIngredients(), ingredientOptions (+16 more)
...
Cohesion: 0.05
Nodes (63): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+55 more)
...
Cohesion: 0.17
Nodes (22): asRecord(), boundedNumber(), boundedString(), boundedStringList(), normalizeCalendarEvent(), normalizeCalendarToken(), normalizeDeadline(), normalizeIcsSubscription() (+14 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (21): defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber() (+13 more)
...
Cohesion: 0.09
Nodes (34): ConfirmDialog(), AppButton(), Badge(), RecipeEditorOutput, TrackPrototypeEvent, cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines() (+26 more)
...
Cohesion: 0.21
Nodes (15): asRecord(), boundedNumber(), boundedString(), boundedStringList(), normalizeCalendarEvent(), normalizeCalendarToken(), normalizeDayContext(), normalizeDeadline() (+7 more)
...
Cohesion: 0.22
Nodes (10): float, str, client(), _cosine(), fake_embed_single(), fake_embed_texts(), _parse_vector(), Shared test fixtures for the recommender API.  The suite never touches a real Po (+2 more)
...
## Knowledge Gaps
- **1013 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+1008 more)
...
- **Why does `recompute_user_profile()` connect `Community 8` to `Community 64`, `Community 19`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Random` connect `Community 19` to `Community 17`?**
