...
## Corpus Check
- 236 files · ~379,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2805 nodes · 5140 edges · 160 communities (145 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a71ece2b`
...
Cohesion: 0.07
Nodes (44): IngredientEditor(), Field(), defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote() (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (39): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, formatPortionNote(), allSlots, mealTypeIcon, priceDiff() (+31 more)
...
Cohesion: 0.07
Nodes (36): Badge(), DeadlineFoodApp(), DiscoverRecommendationRequest, isAppScreen(), onboardingScreens, replaceScreenUrl(), screenFromLocation(), screens (+28 more)
...
Cohesion: 0.09
Nodes (34): GoogleIcon(), MicrosoftIcon(), AppButton(), ChoiceGroup(), AccountMessageTone, AccountProviderId, AccountSummary, EmailMagicLinkOptions (+26 more)
...
Cohesion: 0.08
Nodes (29): ConfirmDialog(), RecipeEditorOutput, Shell(), TrackEvent, fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl() (+21 more)
...
Cohesion: 0.16
Nodes (21): appButtonClasses, AppButtonVariant, badgeTones, Tone, UniversityField(), cn(), CardAction(), CardDescription() (+13 more)
...
Cohesion: 0.13
Nodes (28): getDeadlineFoodAuthToken(), authHeaders(), cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), deleteRecommenderRecipe(), fetchRecipeStates(), fetchRecommenderRecommendations() (+20 more)
...
Cohesion: 0.15
Nodes (14): firebaseFunctionUrl(), AutoPlanResponse, computePlanSignature(), contextEvents(), generateAutoPlan(), GenerateAutoPlanInput, fetchRecipeCatalogue(), planMeals (+6 more)
...
Cohesion: 0.17
Nodes (11): AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, posthog, registerPostHogContext(), registerPostHogSession(), token (+3 more)
...
- **Why does `RecipeIngredient` connect `Community 58` to `Community 3`, `Community 6`, `Community 7`, `Community 59`, `Community 45`, `Community 47`, `Community 82`, `Community 53`, `Community 27`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 53` to `Community 65`, `Community 82`, `Community 57`, `Community 39`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 2` to `Community 84`, `Community 30`, `Community 23`?**
