...
## Corpus Check
- 218 files · ~156,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2544 nodes · 4614 edges · 148 communities (133 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dedce52d`
...
Cohesion: 0.06
Nodes (50): IngredientEditor(), Field(), defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm() (+42 more)
...
Cohesion: 0.07
Nodes (40): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent (+32 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (43): BudgetCard(), entryTotal(), ConfirmDialog(), AppButton(), appButtonClasses, AppButtonVariant, Badge(), badgeTones (+35 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (40): GoogleIcon(), MicrosoftIcon(), ChoiceGroup(), calendarWarning, chilli, desktopNav, planDays, sessionLoaded (+32 more)
...
Cohesion: 0.10
Nodes (27): seededMeals, canonicalConstraints, deadlineBootstrap, prototypeMeta, formatIngredient(), ingredientKey(), recipeIngredients(), MealOption (+19 more)
...
Cohesion: 0.09
Nodes (21): firebaseFunctionUrl(), uploadRecipePhoto(), ContextEventInput, deadlineToContextEvent(), Shell(), AnalyticsProperties, AutoPlanResponse, computePlanSignature() (+13 more)
...
Cohesion: 0.13
Nodes (18): SelectField(), currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), formatShoppingList(), GroceryVendor, groceryVendorById() (+10 more)
...
Cohesion: 0.20
Nodes (12): RecipeIngredient, fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl(), submitRecipeReview(), DiscoverRecommendationStatus, MealType (+4 more)
...
Cohesion: 0.24
Nodes (7): posthog, registerPostHogSession(), loadBrowserPublicEnv(), PublicEnvWindow, DeadlineFoodPrototype(), isAppScreen(), App()
...
Cohesion: 0.33
Nodes (7): readBrowserPublicEnv(), firebaseAuthEmulatorUrl(), firebaseConfig(), firebaseProjectId(), readBrowserOverride(), readPublicEnv(), readRuntimeEnv()
...
## Knowledge Gaps
- **979 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+974 more)
...
- **Why does `recompute_user_profile()` connect `Community 2` to `Community 65`, `Community 75`, `Community 20`?**
