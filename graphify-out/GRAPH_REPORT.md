...
## Summary
- 2227 nodes · 4153 edges · 142 communities (121 shown, 21 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 152 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `87bb816d`
...
Cohesion: 0.05
Nodes (104): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), score_difficulty(), embed_single(), embed_texts(), get_model() (+96 more)
...
Cohesion: 0.03
Nodes (61): allowedPhotoMimeTypes, anonymousSessionsRef, CalendarEvent, calendarFetchIcs, calendarGoogleExchange, calendarOAuthSecrets, calendarOutlookExchange, calendarSubscriptionRefresh (+53 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (29): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), IngredientEditor(), defaultForm(), mealToForm(), allergens (+21 more)
...
Cohesion: 0.26
Nodes (16): BudgetSummary(), DailyPlanCard(), EventLog(), FallbackMealCard(), eventLabel(), formatPence(), mealTypeLabel(), strategyName() (+8 more)
...
Cohesion: 0.13
Nodes (20): clamp(), countableUnits, formatIngredient(), ingredientAliases, ingredientOptions, ingredientPreparations, ingredientSearchTerm(), ingredientUnits (+12 more)
...
Cohesion: 0.13
Nodes (12): Shell(), AnalyticsProperties, TrackPrototypeEvent, seedMeals, DeadlineFoodPrototype(), isAppScreen(), onboardingScreens, screens (+4 more)
...
Cohesion: 0.08
Nodes (38): firebaseFunctionUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse (+30 more)
...
Cohesion: 0.25
Nodes (12): fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl(), submitRecipeReview(), groceryVendorById(), RecipeReview, PlanScreen() (+4 more)
...
Cohesion: 0.16
Nodes (14): EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, positiveNumber(), RecipeEditor(), TAG_OPTIONS, RecipeIngredient, sanitiseIngredientDrafts() (+6 more)
...
Cohesion: 0.13
Nodes (18): BootstrapBoundary(), createDeadlineModeCommands(), DeadlineModeCommands, DeadlineModeState, initialDeadlineModeState, createEventBus(), EventBus, DeadlineSetupPage() (+10 more)
...
Cohesion: 0.15
Nodes (14): calendarWarning, desktopNav, sessionLoaded, defaultDeadlines, initialPlan, initialPreferences, mealSlots, createPrototypeSessionSettings() (+6 more)
...
Cohesion: 0.32
Nodes (6): ConfirmDialog(), AppButton(), RecipeEditorOutput, RecipesHubScreen(), StateSetter, Tab
...
## Knowledge Gaps
- **837 isolated node(s):** `firestore`, `prototypeRef`, `recipesRef`, `recipeReviewsRef`, `anonymousSessionsRef` (+832 more)
...
- **Why does `main()` connect `Community 66` to `Community 48`, `Community 18`, `Community 2`, `Community 44`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `listRecipes()` connect `Community 2` to `Community 66`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
...
- **What connects `firestore`, `prototypeRef`, `recipesRef` to the rest of the system?**
