...
## Corpus Check
- 156 files · ~93,320 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1576 nodes · 2775 edges · 109 communities (94 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa498f70`
...
- `get_recommendations()` --calls--> `recommend()`  [EXTRACTED]
  /home/kolesniii/uni/drp03/backend/recommender-api/app/main.py → /home/kolesniii/uni/drp03/backend/recommender-api/app/recommend.py
...
Cohesion: 0.09
Nodes (49): BootstrapBoundary(), createEventBus(), EventBus, BudgetSummary(), DailyPlanCard(), EventLog(), FallbackMealCard(), eventLabel() (+41 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (54): allEvents, allowedPhotoMimeTypes, anonymousSessionsRef, app_1, body, bucket, calendarOAuthSecrets, calendarUtils_1 (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (55): score_difficulty(), embed_single(), embed_texts(), get_model(), synthesize_recipe_text(), embed_unembedded_recipes(), recompute_all_user_embeddings(), recompute_co_likes() (+47 more)
...
Cohesion: 0.09
Nodes (36): calendarEventsToDeadlines(), IngredientEditor(), ChoiceGroup(), Field(), SelectField(), Shell(), sessionLoaded, allergens (+28 more)
...
Cohesion: 0.13
Nodes (32): BudgetCard(), AppButton(), appButtonClasses, AppButtonVariant, Badge(), badgeTones, Tone, RecipeEditorOutput (+24 more)
...
Cohesion: 0.09
Nodes (35): defaultForm(), EditorForm, mealToForm(), positiveNumber(), RecipeEditor(), RecipeIngredient, clamp(), countableUnits (+27 more)
...
Cohesion: 0.23
Nodes (11): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), parseICSText(), unfoldLines(), CalendarEvent, CalendarProvider (+3 more)
...
## Knowledge Gaps
- **711 isolated node(s):** `indexes`, `fieldOverrides`, `database`, `location`, `rules` (+706 more)
...
- **Why does `Deadline Food Autopilot — Product and Implementation Specification` connect `Community 28` to `Community 44`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `RecipeIngredient` connect `Community 9` to `Community 7`, `Community 8`, `Community 14`, `Community 48`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 0` to `Community 9`, `Community 5`, `Community 14`, `Community 7`?**
