...
## Corpus Check
- 186 files · ~116,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2042 nodes · 3774 edges · 139 communities (116 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 151 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6a19143`
...
Cohesion: 0.06
Nodes (70): BootstrapBoundary(), icsSubscriptionHints, IngredientEditor(), appButtonClasses, AppButtonVariant, badgeTones, ChoiceGroup(), Field() (+62 more)
...
Cohesion: 0.17
Nodes (23): BudgetCard(), Badge(), mealTypeIcon, priceDiff(), slotLabels, SwapModal(), mealSlots, sourceOptions (+15 more)
...
Cohesion: 0.11
Nodes (27): defaultForm(), mealToForm(), clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases (+19 more)
...
Cohesion: 0.11
Nodes (15): AppButton(), Shell(), AnalyticsProperties, TrackPrototypeEvent, initialPlan, seedMeals, DeadlineFoodPrototype(), isAppScreen() (+7 more)
...
Cohesion: 0.14
Nodes (15): EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, positiveNumber(), RecipeEditor(), RecipeEditorOutput, TAG_OPTIONS, RecipeIngredient (+7 more)
...
Cohesion: 0.15
Nodes (13): calendarWarning, desktopNav, sessionLoaded, defaultDeadlines, initialPreferences, createPrototypeSessionSettings(), mealSlots, PrototypeSessionSettings (+5 more)
...
## Knowledge Gaps
- **772 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+767 more)
...
- **Why does `Random` connect `Community 5` to `Community 10`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `extract_context()` connect `Community 4` to `Community 1`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `sample_recipe()` connect `Community 56` to `Community 64`, `Community 1`, `Community 19`, `Community 51`, `Community 57`?**
