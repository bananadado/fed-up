...
## Corpus Check
- 187 files · ~110,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2080 nodes · 4285 edges · 119 communities (106 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 151 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ec5d276`
...
Cohesion: 0.05
Nodes (66): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+58 more)
...
Cohesion: 0.07
Nodes (44): icsSubscriptionHints, CalendarEvent, IngredientEditor(), ChoiceGroup(), Field(), SelectField(), UniversityField(), calendarWarning (+36 more)
...
Cohesion: 0.13
Nodes (23): formatIngredient(), ingredientKey(), recipeIngredients(), MealOption, MealType, PlannedMeal, PrototypeEvent, RecipeDetails (+15 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (21): clamp(), countableUnits, formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientName(), ingredientSearchTerm(), ingredientToDraft() (+13 more)

### Community 14 - "Community 14"
Cohesion: 0.14
Nodes (26): BudgetCard(), Badge(), allSlots, mealTypeIcon, priceDiff(), slotLabels, sortLabels, SortOption (+18 more)
...
Cohesion: 0.09
Nodes (32): AppButton(), defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), positiveNumber(), RecipeEditor() (+24 more)
