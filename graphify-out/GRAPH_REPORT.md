# Graph Report - drp03  (2026-06-17)

## Corpus Check
- 230 files · ~382,338 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3031 nodes · 5534 edges · 174 communities (158 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 153 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2497b21c`
...
8. `recommend()` - 21 edges
9. `compilerOptions` - 20 edges
10. `Card()` - 20 edges

## Surprising Connections (you probably didn't know these)
- `_stage1_filter_and_retrieve()` --calls--> `canonical_tags()`  [INFERRED]
  backend/recommender-api/app/recommend.py → /home/leo/DRP/drp03/backend/recommender-api/app/normalization.py
...
Cohesion: 0.06
Nodes (96): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), score_difficulty(), embed_single(), embed_texts(), get_model() (+88 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (76): accountSessionsRef, allowedPhotoMimeTypes, anonymousSessionsRef, AppData, appDataRef, CalendarEvent, calendarFetchIcs, calendarGoogleExchange (+68 more)
...
Cohesion: 0.12
Nodes (33): BudgetCard(), MealThumbnail(), MealThumbnailProps, AppButton(), Badge(), formatPortionNote(), RecipeEditorOutput, Shell() (+25 more)
...
Cohesion: 0.16
Nodes (15): ClassifiedEvent, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), fetchDeadlineContext(), requestDeadlineContext(), resolveDeadlinesFromEvents() (+7 more)
...
Cohesion: 0.06
Nodes (54): apply, args, asIngredientArray(), asString(), asStringArray(), BREAD_PATTERNS, Candidate, canonicalRecipeName() (+46 more)
...
Cohesion: 0.09
Nodes (40): icsSubscriptionHints, GoogleIcon(), MicrosoftIcon(), IngredientEditor(), ChoiceGroup(), AccountMessageTone, AccountProviderId, AccountSummary (+32 more)
...
Cohesion: 0.21
Nodes (21): BudgetSummary(), DailyPlanCard(), EventLog(), FallbackMealCard(), eventLabel(), formatPence(), mealTypeLabel(), strategyName() (+13 more)
...
Cohesion: 0.10
Nodes (26): sanitiseNumericInput(), clamp(), countableUnits, formatQuantityForInput(), INGREDIENT_DENSITY_G_PER_ML, ingredientAliases, ingredientOptions, ingredientPreparations (+18 more)
...
Cohesion: 0.16
Nodes (34): Any, float, int, object, Request, str, bucket_difficulty(), bucket_prep() (+26 more)
...
Cohesion: 0.10
Nodes (18): mealHealthSignals(), qualitativeTags(), m, vegetableWords, ingredientName(), DiscoverRecommendationState, NutritionSource, ingredientNames() (+10 more)
...
Cohesion: 0.07
Nodes (30): scripts, audit, backup:recipes, build, cleanup:recipes, dev, firebase:artifacts:setpolicy, firebase:data (+22 more)
...
Cohesion: 0.08
Nodes (36): deadlineFoodEndpointUrl(), AnonymousSessionResponse, authHeaders(), clearStoredAnonymousSessionId(), deleteAccountProfile(), getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson() (+28 more)
...
Cohesion: 0.10
Nodes (22): ALLERGEN_DISPLAY, ALLERGEN_ICONS, allergenIcon(), AllergenTag(), ConfirmDialog(), screenFromLocation(), scaleIngredients(), cyrb53() (+14 more)
...
Cohesion: 0.13
Nodes (19): initFirebase(), IngredientNutritionEstimate, authHeaders(), bulkUpsertRecipes(), deleteRecipe(), listRecipes(), RecipeOut, recommenderUrl() (+11 more)
...
Cohesion: 0.12
Nodes (21): args, asText(), baseUrl, DeleteFailure, deleteFirestoreOrphans(), deleteRecommenderOrphans(), fetchFirestoreRecipes(), fetchRecommenderRecipes() (+13 more)
...
Cohesion: 0.13
Nodes (17): defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber(), RecipeEditor() (+9 more)
...
Cohesion: 0.14
Nodes (23): appButtonClasses, AppButtonVariant, badgeTones, Field(), SelectField(), Tone, cn(), PreferenceSection() (+15 more)
...
Cohesion: 0.08
Nodes (23): candidates, counts, candidates, combined, firestore, keptByOverride, manualRemovals, outOfScope (+15 more)
...
Cohesion: 0.09
Nodes (31): currentItemKeys(), readStoredCheckedItems(), SCOPE_OPTIONS, writeStoredCheckedItems(), headNoun(), isUncountableFood(), pluraliseFoodName(), pluraliseIngredientName() (+23 more)
...
Cohesion: 0.09
Nodes (29): cacheDocId(), cacheKeyForName(), categoryTerms(), compactProduct(), cookingAdjectives, estimateIngredientNutrition(), findProductForIngredient(), gramsForIngredient() (+21 more)
...
Cohesion: 0.17
Nodes (17): firebaseFunctionUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), exchangeCodeOnServer(), GoogleExchangeResult, importGoogleCalendar(), isGoogleConfigured(), loadGIS() (+9 more)

### Community 77 - "Community 77"
Cohesion: 0.13
Nodes (14): candidates, counts, candidates, combined, firestore, keptByOverride, manualRemovals, outOfScope (+6 more)
...
Cohesion: 0.13
Nodes (14): counts, deletesPlanned, firestore, firestoreCompared, firestoreOnly, firestoreUnpublishedExcluded, recommender, recommenderOnly (+6 more)
...
Cohesion: 0.19
Nodes (12): BootstrapBoundary(), createEventBus(), EventBus, DeadlineSetupPage(), FallbackBrowsePage(), LandingPage(), RescuePage(), StrategySelectionPage() (+4 more)
...
Cohesion: 0.11
Nodes (13): canonicalConstraints, deadlineBootstrap, productMeta, DeadlineBootstrap, ProductMeta, deadlineBootstrapWithoutMeals, outdir, outfile (+5 more)
...
Cohesion: 0.10
Nodes (22): entryTotal(), AdvancePrepInfo, detectAdvancePrep(), getPrepSuggestions(), PrepSuggestion, requiresSoaking(), meal, plan (+14 more)
...
Cohesion: 0.14
Nodes (13): AnalyticsProperties, AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, posthog, registerPostHogContext(), registerPostHogSession() (+5 more)
...
Cohesion: 0.33
Nodes (5): appRecipes, canonicalConstraints, deadlineBootstrap, GeneratedAppRecipe, productMeta
...
Cohesion: 0.22
Nodes (8): formatIngredient(), parseIngredients(), pluraliseUnit(), [flour], ingredients, [salt], [sugar], describe()
...
## Knowledge Gaps
- **1226 isolated node(s):** `acceptedPrivacyConsent`, `e2eDeadlines`, `e2eMeals`, `e2ePlan`, `calendarWarning` (+1221 more)
...
- **Why does `Ingredient` connect `Community 66` to `Community 8`, `Community 16`, `Community 21`, `Community 59`, `Community 60`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 60` to `Community 59`, `Community 90`, `Community 35`, `Community 61`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `RecipeIngredient` connect `Community 42` to `Community 4`, `Community 9`, `Community 107`, `Community 49`, `Community 18`, `Community 54`, `Community 22`, `Community 25`, `Community 90`, `Community 92`?**
...
- **What connects `acceptedPrivacyConsent`, `e2eDeadlines`, `e2eMeals` to the rest of the system?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.022455805064500716 - nodes in this community are weakly interconnected._