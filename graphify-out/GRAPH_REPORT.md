...
## Corpus Check
- 213 files · ~146,711 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2701 nodes · 5267 edges · 164 communities (152 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 151 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b07dce43`
...
7. `sample_recipe()` - 25 edges
8. `scripts` - 24 edges
9. `MealOption` - 24 edges
10. `_seed_user()` - 23 edges
...
Cohesion: 0.15
Nodes (38): canonical_tag(), canonical_tags(), Canonical text values shared by API validation and recommendation filters., _ability_match(), _ability_profile(), _apply_exploration(), _as_vector(), _blend_weights() (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (26): Shell(), calendarWarning, chilli, desktopNav, planDays, sessionLoaded, AnalyticsProperties, TrackPrototypeEvent (+18 more)
...
Cohesion: 0.08
Nodes (56): BootstrapBoundary(), createDeadlineModeCommands(), DeadlineModeCommands, DeadlineModeState, initialDeadlineModeState, createEventBus(), EventBus, BudgetSummary() (+48 more)
...
Cohesion: 0.13
Nodes (22): recipeIngredients(), MealOption, MealSlot, MealType, PlannedMeal, RecipeDetails, ValidationResult, fallbackCampusHummusBox (+14 more)
...
Cohesion: 0.09
Nodes (33): positiveNumber(), RecipeEditor(), currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), scaleIngredients(), fetchRecipeReviews() (+25 more)
...
Cohesion: 0.10
Nodes (23): ConfirmDialog(), AppButton(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote() (+15 more)
...
Cohesion: 0.07
Nodes (43): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+35 more)
...
Cohesion: 0.07
Nodes (46): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent (+38 more)
...
Cohesion: 0.10
Nodes (35): icsSubscriptionHints, IngredientEditor(), appButtonClasses, AppButtonVariant, badgeTones, ChoiceGroup(), Field(), SelectField() (+27 more)
...
Cohesion: 0.15
Nodes (12): seededMeals, canonicalConstraints, deadlineBootstrap, prototypeMeta, PrototypeMeta, seedMeals, outdir, outfile (+4 more)
...
## Knowledge Gaps
- **989 isolated node(s):** `database`, `location`, `rules`, `indexes`, `rules` (+984 more)
