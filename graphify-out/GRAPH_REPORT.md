...
## Corpus Check
- 186 files · ~116,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2042 nodes · 3756 edges · 137 communities (114 shown, 23 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 130 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3c711f9`
...
5. `recommend()` - 21 edges
6. `compilerOptions` - 20 edges
7. `Card()` - 20 edges
8. `AsyncSession` - 19 edges
9. `scripts` - 19 edges
10. `extract_context()` - 18 edges
...
- `test_classify_event_keywords()` --calls--> `classify_event()`  [INFERRED]
  backend/recommender-api/tests/test_context.py → backend/recommender-api/app/context.py
- `test_deadline_keyword_beats_study_keyword()` --calls--> `classify_event()`  [INFERRED]
  backend/recommender-api/tests/test_context.py → backend/recommender-api/app/context.py
- `test_long_untitled_event_is_work_shift()` --calls--> `classify_event()`  [INFERRED]
  backend/recommender-api/tests/test_context.py → backend/recommender-api/app/context.py
...
Cohesion: 0.06
Nodes (91): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), embed_single(), embed_texts(), get_model(), Qualitative bucket for prep time.      Synthesized natural-language descriptions (+83 more)
...
Cohesion: 0.08
Nodes (37): seededMeals, canonicalConstraints, deadlineBootstrap, prototypeMeta, formatIngredient(), ingredientKey(), recipeIngredients(), DeadlineBootstrap (+29 more)
...
Cohesion: 0.18
Nodes (20): BudgetCard(), mealTypeIcon, priceDiff(), slotLabels, SwapModal(), mealHealthSignals(), vegetableWords, ingredientName() (+12 more)
...
Cohesion: 0.12
Nodes (24): AppButton(), clamp(), countableUnits, formatIngredient(), formatQuantityForInput(), ingredientAliases, IngredientDraft, ingredientOptions (+16 more)
...
Cohesion: 0.15
Nodes (17): ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), fetchDeadlineContext(), requestDeadlineContext() (+9 more)
...
Cohesion: 0.20
Nodes (9): Badge(), RecipeEditorOutput, TrackPrototypeEvent, Preferences, Screen, ingredientNames(), StateSetter, StateSetter (+1 more)
...
Cohesion: 0.18
Nodes (16): cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), fetchRecommenderRecommendations(), functionUrl(), readJson(), RecommenderInteractionAction, RecommenderRecipe (+8 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (23): AnalyticsProperties, AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, registerPostHogContext(), registerPostHogSession(), token (+15 more)
...
Cohesion: 0.15
Nodes (15): defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), positiveNumber(), TAG_OPTIONS, RecipeIngredient (+7 more)
...
Cohesion: 0.18
Nodes (17): float, int, object, Request, str, fetch_vectors(), health(), index() (+9 more)
...
Cohesion: 0.13
Nodes (25): appButtonClasses, AppButtonVariant, badgeTones, Field(), SelectField(), Tone, Shell(), UniversityField() (+17 more)
...
Cohesion: 0.16
Nodes (12): calendarWarning, desktopNav, sessionLoaded, defaultDeadlines, initialPreferences, createPrototypeSessionSettings(), mealSlots, PrototypeSessionSettings (+4 more)
...
Cohesion: 0.15
Nodes (21): icsSubscriptionHints, IngredientEditor(), ChoiceGroup(), allergens, calendarProviders, cookingAbilities, dietary, dislikes (+13 more)
...
Cohesion: 0.27
Nodes (11): posthog, AnonymousSessionResponse, getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson(), readStoredSessionId(), saveAnonymousSessionSettings(), storeSessionId() (+3 more)
...
Cohesion: 0.23
Nodes (13): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarOutlookExchangeUrl(), base64UrlEncode(), exchangeCodeOnServer() (+5 more)
...
Cohesion: 0.26
Nodes (12): RecipeEditor(), fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl(), submitRecipeReview(), RecipeReview, nutritionSourceSummary() (+4 more)
...
## Knowledge Gaps
- **774 isolated node(s):** `object`, `Request`, `str`, `calendarWarning`, `desktopNav` (+769 more)
...
- **Why does `recompute_user_profile()` connect `Community 1` to `Community 64`, `Community 57`, `Community 5`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 41` to `Community 0`, `Community 11`, `Community 14`, `Community 21`, `Community 22`, `Community 61`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `FakeSession` connect `Community 64` to `Community 56`, `Community 57`, `Community 51`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.06059330948874395 - nodes in this community are weakly interconnected._
