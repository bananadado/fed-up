...
## Corpus Check
- 174 files · ~106,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1860 nodes · 3454 edges · 127 communities (104 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 136 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9b0421e`
...
6. `sample_recipe()` - 22 edges
7. `Card()` - 21 edges
8. `compilerOptions` - 20 edges
9. `scripts` - 19 edges
10. `Development And Testing` - 18 edges
...
Cohesion: 0.07
Nodes (85): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), embed_single(), embed_texts(), get_model(), _compute_taste_embedding() (+77 more)
...
Cohesion: 0.16
Nodes (25): BudgetCard(), Badge(), priceDiff(), slotLabels, SwapModal(), seedMeals, mealHealthSignals(), vegetableWords (+17 more)
...
Cohesion: 0.15
Nodes (20): AppButton(), Field(), defaultForm(), EditorForm, mealToForm(), positiveNumber(), RecipeEditor(), RecipeEditorOutput (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (36): _clamp(), classify_event(), daily_context(), extract_context(), extract_deadlines(), normalize_event(), _parse_dt(), Calendar deadline extraction & daily-context inference (issue #65).  This is a * (+28 more)
...
Cohesion: 0.14
Nodes (18): currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), aggregateIngredients(), formatShoppingList(), GroceryVendor, groceryVendorById() (+10 more)
...
Cohesion: 0.39
Nodes (14): _blend_weights(), _budget_score(), _collaborative_scores(), _cosine_sim(), _get_user(), _health_score(), _recently_seen(), recommend() (+6 more)
...
Cohesion: 0.22
Nodes (6): FakeSession, Interprets the SQL the API issues against in-memory dicts., Interprets the SQL the API issues against in-memory dicts., _upsert_recipe(), test_embed_unembedded_recipes_job(), test_embed_unembedded_recipes_noop_when_all_embedded()
...
Cohesion: 0.19
Nodes (8): float, str, client(), fake_embed_single(), fake_embed_texts(), Shared test fixtures for the recommender API.  The suite never touches a real Po, Stable pseudo-embedding derived from the text hash (no torch needed)., Stable pseudo-embedding derived from the text hash (no torch needed).
...
Cohesion: 0.08
Nodes (41): icsSubscriptionHints, calendarEventsToDeadlines(), IngredientEditor(), ChoiceGroup(), SelectField(), Shell(), sessionLoaded, AnalyticsProperties (+33 more)
...
## Knowledge Gaps
- **728 isolated node(s):** `Runtime`, `Stack`, `1. Active Prototype (what users see)`, `2. Dormant React Router Slice (not mounted)`, `code:sh (bun install                  # install dependencies)` (+723 more)
...
- **Why does `Deadline Food Autopilot — Product and Implementation Specification` connect `Community 31` to `Community 128`, `Community 50`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 0` to `Community 48`, `Community 15`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `sample_recipe()` connect `Community 47` to `Community 48`, `Community 41`, `Community 60`, `Community 77`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.07047300525561395 - nodes in this community are weakly interconnected._