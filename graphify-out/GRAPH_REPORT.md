...
## Corpus Check
- 187 files · ~111,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2082 nodes · 4289 edges · 125 communities (112 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 151 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f800d76d`
...
3. `recommend()` - 26 edges
4. `AsyncSession` - 26 edges
5. `sample_recipe()` - 25 edges
6. `MealOption` - 24 edges
7. `scripts` - 21 edges
8. `log_event()` - 21 edges
...
Cohesion: 0.06
Nodes (104): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), embed_single(), embed_texts(), get_model(), Qualitative bucket for prep time.      Synthesized natural-language descriptions (+96 more)

### Community 1 - "Community 1"
Cohesion: 0.15
Nodes (15): ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), fetchDeadlineContext(), requestDeadlineContext() (+7 more)
...
Cohesion: 0.14
Nodes (23): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), ChoiceGroup(), UniversityField(), allergens, calendarProviders (+15 more)
...
Cohesion: 0.12
Nodes (24): formatIngredient(), ingredientKey(), recipeIngredients(), KitchenAccess, MealOption, MealType, PlannedMeal, RankedStrategy (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (23): defaultForm(), clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, IngredientDraft (+15 more)

### Community 14 - "Community 14"
Cohesion: 0.18
Nodes (22): BudgetCard(), Badge(), allSlots, mealTypeIcon, priceDiff(), slotLabels, sortLabels, SortOption (+14 more)
...
Cohesion: 0.10
Nodes (30): AppButton(), Field(), SelectField(), positiveNumber(), RecipeEditor(), currentItemKeys(), readStoredCheckedItems(), ShoppingListCard() (+22 more)
...
Cohesion: 0.08
Nodes (22): Shell(), calendarWarning, desktopNav, sessionLoaded, defaultDeadlines, initialPlan, initialPreferences, DeadlineFoodPrototype() (+14 more)
...
Cohesion: 0.16
Nodes (17): cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), fetchRecommenderRecommendations(), functionUrl(), readJson(), RecommenderInteractionAction, RecommenderRecipe (+9 more)
...
Cohesion: 0.12
Nodes (20): DeadlineModeAction, DeadlineModeInternalAction, deadlineModeReducer(), withEvent(), sortByPreferredFallback(), validateConstraints(), constraints, expectedTotal (+12 more)

### Community 56 - "Community 56"
Cohesion: 0.24
Nodes (7): RecipeEditorOutput, AnalyticsProperties, TrackPrototypeEvent, Landing(), RecipesHubScreen(), StateSetter, Tab
...
Cohesion: 0.14
Nodes (15): IngredientEditor(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), TAG_OPTIONS (+7 more)
...
## Knowledge Gaps
- **730 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+725 more)
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.06258148631029987 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.0720658888126287 - nodes in this community are weakly interconnected._