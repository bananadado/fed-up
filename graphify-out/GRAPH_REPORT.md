...
## Corpus Check
- 200 files · ~135,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2265 nodes · 4125 edges · 129 communities (114 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `efa49681`
...
Cohesion: 0.03
Nodes (69): allowedPhotoMimeTypes, anonymousSessionsRef, CalendarEvent, calendarFetchIcs, calendarGoogleExchange, calendarOAuthSecrets, calendarOutlookExchange, calendarSubscriptionRefresh (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (61): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+53 more)
...
Cohesion: 0.11
Nodes (37): BudgetCard(), ConfirmDialog(), AppButton(), Badge(), allSlots, mealTypeIcon, priceDiff(), slotLabels (+29 more)
...
Cohesion: 0.06
Nodes (32): Shell(), calendarWarning, chilli, desktopNav, planDays, sessionLoaded, AutoPlanResponse, computePlanSignature() (+24 more)
...
Cohesion: 0.11
Nodes (23): importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (28): icsSubscriptionHints, IngredientEditor(), Field(), SelectField(), UniversityField(), allergens, calendarProviders, cookingAbilities (+20 more)

### Community 18 - "Community 18"
Cohesion: 0.10
Nodes (30): RecipeEditorOutput, currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), fetchRecipeReviews(), readJson(), RecipeReviewsResult (+22 more)
...
Cohesion: 0.15
Nodes (21): appButtonClasses, AppButtonVariant, badgeTones, ChoiceGroup(), Tone, cn(), CardAction(), CardDescription() (+13 more)
...
Cohesion: 0.07
Nodes (22): AllocatorMeal, Band, buildPlan(), BuildPlanInput, classifyEffort(), DayContext, Effort, Leftover (+14 more)
...
Cohesion: 0.11
Nodes (25): defaultForm(), clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientName() (+17 more)
...
Cohesion: 0.15
Nodes (14): EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber(), RecipeEditor() (+6 more)
...
## Knowledge Gaps
- **856 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+851 more)
...
- **Why does `Random` connect `Community 7` to `Community 19`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 1` to `Community 65`, `Community 58`, `Community 7`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.024670109007458405 - nodes in this community are weakly interconnected._
