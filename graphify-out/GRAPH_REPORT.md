...
## Corpus Check
- 236 files · ~379,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2908 nodes · 5820 edges · 161 communities (148 shown, 13 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 171 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95fe7833`
...
Cohesion: 0.10
Nodes (31): clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, IngredientDraft, ingredientDraftsFromIngredients() (+23 more)
...
Cohesion: 0.11
Nodes (31): GoogleIcon(), MicrosoftIcon(), IngredientEditor(), ChoiceGroup(), Field(), SelectField(), UniversityField(), AccountMessageTone (+23 more)
...
Cohesion: 0.10
Nodes (25): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), ClassifiedEvent, ContextEventInput, DailyContext (+17 more)
...
Cohesion: 0.27
Nodes (14): getDeadlineFoodAuthToken(), AnonymousSessionResponse, authHeaders(), clearStoredAnonymousSessionId(), deleteAccountProfile(), getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson() (+6 more)
...
Cohesion: 0.11
Nodes (16): ConfirmDialog(), AppButton(), RecipeEditorOutput, DiscoverRecommendationState, DiscoverRecommendationTrigger, ingredientNames(), isRecipeOwnedBy(), isVerified() (+8 more)

### Community 88 - "Community 88"
Cohesion: 0.18
Nodes (18): appButtonClasses, AppButtonVariant, badgeTones, Tone, cn(), PreferenceSection(), Input(), Label() (+10 more)
...
Cohesion: 0.38
Nodes (7): accountSessionHandle(), accountSessionDocId(), accountSessionHandle(), handleAccountSessionDelete(), handleAccountSessionGet(), sendSessionJson(), timestampToIso()
...
Cohesion: 0.06
Nodes (39): Badge(), Shell(), TrackEvent, defaultDeadlines, initialPlan, initialPreferences, seedMeals, DeadlineFoodApp() (+31 more)
...
## Knowledge Gaps
- **1055 isolated node(s):** `deploymentEnabled`, `BuildConfigOverrides`, `NestedBuildConfig`, `cliConfig`, `start` (+1050 more)
...
- **Why does `RecipeIngredient` connect `Community 142` to `Community 7`, `Community 8`, `Community 44`, `Community 45`, `Community 16`, `Community 22`, `Community 59`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 69` to `Community 34`, `Community 55`, `Community 22`, `Community 159`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `sample_recipe()` connect `Community 26` to `Community 2`?**
