...
## Corpus Check
- 238 files · ~383,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2931 nodes · 5854 edges · 165 communities (153 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 171 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c250130c`
...
Cohesion: 0.02
Nodes (81): anonymousSessionsRef, firestore, publicHttpOptions, accountSessionsRef, allowedPhotoMimeTypes, anonymousSessionsRef, AppData, appDataRef (+73 more)
...
Cohesion: 0.07
Nodes (41): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (40): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, ShoppingListCard(), allSlots, mealTypeIcon, priceDiff() (+32 more)
...
Cohesion: 0.05
Nodes (48): firebaseFunctionUrl(), uploadRecipePhoto(), AutoPlanResponse, computePlanSignature(), contextEvents(), generateAutoPlan(), GenerateAutoPlanInput, defaultDeadlines (+40 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (30): clamp(), countableUnits, formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientName(), ingredientOptions, ingredientPreparations (+22 more)
...
Cohesion: 0.07
Nodes (37): seededMeals, canonicalConstraints, deadlineBootstrap, productMeta, formatIngredient(), ingredientKey(), recipeIngredients(), DeadlineBootstrap (+29 more)
...
Cohesion: 0.24
Nodes (17): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+9 more)
...
Cohesion: 0.10
Nodes (33): GoogleIcon(), MicrosoftIcon(), IngredientEditor(), AppButton(), appButtonClasses, AppButtonVariant, badgeTones, ChoiceGroup() (+25 more)
...
Cohesion: 0.11
Nodes (31): fetchOpenFoodFactsNutrition(), authHeaders(), cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), deleteRecommenderRecipe(), fetchRecipeStates(), fetchRecommenderRecommendations() (+23 more)
...
Cohesion: 0.18
Nodes (30): asRecord(), boundedNumber(), boundedString(), boundedStringList(), normalizeDeadline(), readRequestBody(), asRecord(), boundedNumber() (+22 more)
...
Cohesion: 0.13
Nodes (21): screenFromLocation(), cyrb53(), recipeShareToken(), recipeShareUrl(), shareIdForRecipe(), a, b, fetchRecipeReviews() (+13 more)
...
Cohesion: 0.20
Nodes (14): cn(), CardAction(), CardDescription(), CardFooter(), Label(), Select(), SelectContent(), SelectItem() (+6 more)
...
Cohesion: 0.14
Nodes (16): defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber() (+8 more)
...
Cohesion: 0.13
Nodes (14): ConfirmDialog(), Badge(), RecipeEditorOutput, Shell(), TrackEvent, DiscoverRecommendationState, Screen, AnalyticsProperties (+6 more)
...
Cohesion: 0.30
Nodes (13): getDeadlineFoodAuthToken(), AnonymousSessionResponse, authHeaders(), clearStoredAnonymousSessionId(), deleteAccountProfile(), getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson() (+5 more)
...
Cohesion: 0.33
Nodes (7): firebaseAuthEmulatorUrl(), firebaseConfig(), firebaseProjectId(), readBrowserOverride(), readPublicEnv(), readRuntimeEnv(), readBrowserPublicEnv()
...
## Knowledge Gaps
- **1059 isolated node(s):** `database`, `location`, `rules`, `indexes`, `rules` (+1054 more)
...
- **Why does `RecipeIngredient` connect `Community 29` to `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 46`, `Community 79`, `Community 85`, `Community 54`, `Community 61`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 54` to `Community 56`, `Community 67`, `Community 36`, `Community 79`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `estimateRecipeCostPence()` connect `Community 54` to `Community 32`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02017894536455359 - nodes in this community are weakly interconnected._
