...
## Corpus Check
- 176 files · ~110,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1945 nodes · 3587 edges · 126 communities (103 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b3c14eb`
...
Cohesion: 0.06
Nodes (66): BootstrapBoundary(), createDeadlineModeCommands(), DeadlineModeCommands, DeadlineModeState, initialDeadlineModeState, createEventBus(), EventBus, appButtonClasses (+58 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (87): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), embed_single(), embed_texts(), get_model(), Qualitative bucket for prep time.      Synthesized natural-language descriptions (+79 more)
...
Cohesion: 0.09
Nodes (30): defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), positiveNumber(), RecipeEditor(), TAG_OPTIONS (+22 more)

### Community 8 - "Community 8"
Cohesion: 0.15
Nodes (29): BudgetCard(), Badge(), priceDiff(), slotLabels, SwapModal(), seedMeals, mealHealthSignals(), vegetableWords (+21 more)
...
Cohesion: 0.11
Nodes (35): _clamp(), classify_event(), daily_context(), extract_context(), extract_deadlines(), normalize_event(), _parse_dt(), Calendar deadline extraction & daily-context inference (issue #65).  This is a * (+27 more)
...
Cohesion: 0.09
Nodes (37): calendarEventsToDeadlines(), IngredientEditor(), ChoiceGroup(), Field(), sessionLoaded, allergens, calendarProviders, cookingAbilities (+29 more)
...
Cohesion: 0.21
Nodes (9): AppButton(), RecipeEditorOutput, Shell(), AnalyticsProperties, TrackPrototypeEvent, Landing(), RecipesHubScreen(), StateSetter (+1 more)
...
Cohesion: 0.21
Nodes (13): RecipeIngredient, cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), fetchRecommenderRecommendations(), functionUrl(), readJson(), RecommenderInteractionAction (+5 more)

### Community 50 - "Community 50"
Cohesion: 0.18
Nodes (13): sample_user(), Endpoint tests for user profiles and ability derivation (issue #59)., Liked recipes pull the embedding in, disliked recipes push it away., Liked recipes pull the embedding in, disliked recipes push it away., test_ability_defaults_to_neutral_for_new_user(), test_ability_derived_from_onboarding_on_creation(), test_create_and_get_user(), test_negative_interaction_also_recomputes_profile() (+5 more)
...
- **Why does `sample_recipe()` connect `Community 39` to `Community 65`, `Community 1`, `Community 50`, `Community 53`, `Community 60`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 1` to `Community 65`, `Community 50`, `Community 12`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
