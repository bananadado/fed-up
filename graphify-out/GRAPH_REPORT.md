...
## Corpus Check
- 236 files · ~378,608 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2915 nodes · 5853 edges · 159 communities (147 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 170 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10cc5f23`
...
Cohesion: 0.02
Nodes (76): accountRef, accountSessionsRef, allEvents, allowedPhotoMimeTypes, anonymousSessionsRef, app_1, appData_1, appDataRef (+68 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (110): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), get_db(), embed_single(), embed_texts(), get_model(), Qualitative bucket for prep time.      Synthesized natural-language descriptions (+102 more)
...
Cohesion: 0.09
Nodes (29): clamp(), countableUnits, formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientName(), ingredientOptions, ingredientPreparations (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (39): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, Badge(), allSlots, mealTypeIcon, priceDiff() (+31 more)
...
Cohesion: 0.06
Nodes (41): defaultDeadlines, initialPlan, initialPreferences, DeadlineFoodApp(), isAppScreen(), onboardingScreens, replaceScreenUrl(), screens (+33 more)
...
Cohesion: 0.09
Nodes (35): seededMeals, canonicalConstraints, deadlineBootstrap, productMeta, seedMeals, formatIngredient(), ingredientKey(), recipeIngredients() (+27 more)
...
Cohesion: 0.11
Nodes (31): icsSubscriptionHints, GoogleIcon(), MicrosoftIcon(), IngredientEditor(), AppButton(), ChoiceGroup(), UniversityField(), AccountMessageTone (+23 more)
...
Cohesion: 0.24
Nodes (7): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), parseICSText(), unfoldLines()
...
Cohesion: 0.14
Nodes (25): authHeaders(), cookingAbility(), createRecommenderRecipe(), deadlineStressFromDeadlines(), deleteRecommenderRecipe(), fetchRecipeStates(), fetchRecommenderRecommendations(), fetchSharedRecipe() (+17 more)
...
Cohesion: 0.21
Nodes (14): COUNT_UNIT_DEFAULT_GRAMS, gramsForIngredientUnit(), normalizeIngredientUnit(), normalizeText(), ParsedIngredientMeasure, parseMeasureToIngredient(), parseQuantity(), SIZE_UNIT_MULTIPLIER (+6 more)
...
Cohesion: 0.11
Nodes (21): ConfirmDialog(), defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote() (+13 more)
...
Cohesion: 0.10
Nodes (26): screenFromLocation(), scaleIngredients(), cyrb53(), recipeShareToken(), recipeShareUrl(), shareIdForRecipe(), a, b (+18 more)

### Community 88 - "Community 88"
Cohesion: 0.13
Nodes (24): appButtonClasses, AppButtonVariant, badgeTones, Field(), SelectField(), Tone, mealSlots, planningWeekDays (+16 more)
...
## Knowledge Gaps
- **1056 isolated node(s):** `deploymentEnabled`, `BuildConfigOverrides`, `NestedBuildConfig`, `cliConfig`, `start` (+1051 more)
...
- **Why does `RecipeIngredient` connect `Community 16` to `Community 66`, `Community 7`, `Community 72`, `Community 8`, `Community 12`, `Community 44`, `Community 45`, `Community 22`, `Community 56`, `Community 59`?**
...
- **Why does `CalendarEvent` connect `Community 142` to `Community 32`, `Community 6`, `Community 8`, `Community 12`, `Community 21`, `Community 150`, `Community 58`, `Community 159`?**
