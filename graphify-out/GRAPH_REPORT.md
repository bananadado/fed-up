...
## Corpus Check
- 242 files · ~395,043 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2969 nodes · 5402 edges · 181 communities (165 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 98 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `417d476d`
...
3. `scripts` - 29 edges
4. `MealOption` - 24 edges
5. `Meal` - 24 edges
6. `_seed_user()` - 22 edges
7. `sample_recipe()` - 21 edges
...
Cohesion: 0.02
Nodes (78): anonymousSessionsRef, estimateIngredientNutrition(), firestore, gramsForIngredient(), nutritionHttpOptions, openFoodFactsCacheRef, publicHttpOptions, roundMacro() (+70 more)
...
Cohesion: 0.07
Nodes (47): blockMinutes(), buildCookingIcs(), buildCookingVEvent(), buildGoogleCalendarUrl(), buildShoppingGoogleCalendarUrl(), buildShoppingVEvent(), CookingCalendarBlock, cookingIcsFilename() (+39 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (33): seededMeals, canonicalConstraints, deadlineBootstrap, productMeta, seedMeals, formatIngredient(), ingredientKey(), recipeIngredients() (+25 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (48): currentItemKeys(), readStoredCheckedItems(), SCOPE_OPTIONS, writeStoredCheckedItems(), headNoun(), INGREDIENT_DENSITY_G_PER_ML, isUncountableFood(), ITEM_WEIGHT_G (+40 more)
...
Cohesion: 0.08
Nodes (36): sanitiseNumericInput(), defaultForm(), clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases (+28 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (29): GoogleIcon(), MicrosoftIcon(), IngredientEditor(), ChoiceGroup(), SelectField(), AccountMessageTone, AccountProviderId, AccountSummary (+21 more)
...
Cohesion: 0.08
Nodes (34): aggregationUnit(), canonicalizeUnit(), cleanEmbeddedIngredient(), displayFromBase(), imperialMassDisplay(), imperialVolumeDisplay(), MASS_TO_G_BASE, MASS_UNITS (+26 more)
...
Cohesion: 0.13
Nodes (34): bulk_create_recipes(), create_recipe(), create_user(), delete_recipe(), get_recipe(), get_recommendations(), get_user(), get_user_ability() (+26 more)
...
Cohesion: 0.13
Nodes (24): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, formatPortionNote(), ShoppingListCard(), allSlots, mealTypeIcon (+16 more)
...
Cohesion: 0.11
Nodes (20): ALLERGEN_DISPLAY, ALLERGEN_ICONS, allergenIcon(), AllergenTag(), ConfirmDialog(), AppButton(), appButtonClasses, AppButtonVariant (+12 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (25): defaultDeadlines, initialPlan, initialPreferences, CalendarToken, createPrivacyConsent(), createSessionSettings(), IcsSubscription, mealSlots (+17 more)
...
Cohesion: 0.18
Nodes (16): cn(), CardAction(), CardDescription(), CardFooter(), Input(), Label(), Select(), SelectContent() (+8 more)
...
Cohesion: 0.15
Nodes (25): asRecord(), boundedNumber(), boundedString(), boundedStringList(), normalizeDeadline(), normalizeRecipeList(), readRequestBody(), callRecommenderJson() (+17 more)

### Community 43 - "Community 43"
Cohesion: 0.11
Nodes (18): EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber(), RecipeEditor(), TAG_OPTIONS (+10 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (19): Shell(), DeadlineFoodApp(), DiscoverRecommendationRequest, isAppScreen(), onboardingScreens, replaceScreenUrl(), screenFromLocation(), screens (+11 more)
...
Cohesion: 0.13
Nodes (16): AdvancePrepInfo, detectAdvancePrep(), getPrepSuggestions(), PrepSuggestion, requiresSoaking(), meal, plan, suggestions (+8 more)
...
Cohesion: 0.16
Nodes (15): scaleIngredients(), fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl(), submitRecipeReview(), RecipeReview, isRecipeOwnedBy() (+7 more)
...
Cohesion: 0.17
Nodes (17): AnonymousSessionResponse, authHeaders(), clearStoredAnonymousSessionId(), deleteAccountProfile(), getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson(), readStoredSessionId() (+9 more)

### Community 57 - "Community 57"
Cohesion: 0.12
Nodes (16): AnalyticsProperties, AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, registerPostHogContext(), token, createPostHogConfig() (+8 more)
...
Cohesion: 0.18
Nodes (13): getPlanMeal(), getRecipeCatalogue(), getSessionMeal(), planMeals, sessionMeals, getMealById(), ingredientNames(), keyIngredients() (+5 more)
...
Cohesion: 0.26
Nodes (16): _compute_taste_embedding(), embed_unembedded_recipes(), _parse_embedding(), Recompute a user's taste embedding *and* ability profile (issue #59).      Pulls, recompute_all_user_embeddings(), recompute_all_user_profiles(), recompute_co_likes(), recompute_trending() (+8 more)
...
Cohesion: 0.29
Nodes (9): estimateIngredientCostPence(), estimateRawMeasuresCostPence(), estimateRecipeCostPence(), findIngredientPriceRecord(), IngredientCostEstimate, normalizeName(), roundPenceToNearestFive(), gramsForIngredient() (+1 more)
...
Cohesion: 0.22
Nodes (8): Shared-key verification for requests forwarded by Firebase Functions., Reject application API calls that were not forwarded by a trusted function., verify_cloud_function(), _ensure_verified_column(), lifespan(), Idempotent startup migration for the recipes.verified column (#213).      init.s, FastAPI, Request
...
Cohesion: 0.40
Nodes (6): accountSessionHandle(), sendSessionJson(), timestampToIso(), accountSessionDocId(), handleAccountSessionDelete(), handleAccountSessionGet()
...
## Knowledge Gaps
- **1157 isolated node(s):** `chromiumLaunchOptions`, `lib`, `target`, `module`, `moduleDetection` (+1152 more)
...
- **Why does `RecipeIngredient` connect `Community 68` to `Community 4`, `Community 5`, `Community 43`, `Community 13`, `Community 16`, `Community 25`, `Community 92`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 85` to `Community 65`, `Community 92`, `Community 39`, `Community 63`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 71` to `Community 20`, `Community 22`, `Community 76`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.0219484882418813 - nodes in this community are weakly interconnected._
