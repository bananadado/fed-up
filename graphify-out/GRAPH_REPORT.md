...
Cohesion: 0.03
Nodes (62): allEvents, allowedPhotoMimeTypes, anonymousSessionsRef, app_1, body, bucket, calendarOAuthSecrets, calendarUtils_1 (+54 more)
...
Cohesion: 0.06
Nodes (51): ALLERGEN_KEYWORDS, CATEGORY_FALLBACK_MINUTES, CATEGORY_NUTRITION, CUISINE_FLAVORS, DEFAULT_NUTRITION, detectAllergens(), detectDietaryTags(), detectSuitabilityTags() (+43 more)
...
Cohesion: 0.15
Nodes (16): ClassifiedEvent, ContextEventInput, DailyContext, DeadlineContextResponse, deadlineContextUrl(), deadlinesFromContext(), fetchDeadlineContext(), requestDeadlineContext() (+8 more)
...
Cohesion: 0.14
Nodes (17): cacheDocId(), readCachedProduct(), writeCachedProduct(), authHeaders(), bulkUpsertRecipes(), listRecipes(), recommenderUrl(), RecipeIn (+9 more)
...
Cohesion: 0.25
Nodes (12): posthog, AnonymousSessionResponse, getOrCreateAnonymousSessionId(), loadAnonymousSessionSettings(), readJson(), readStoredSessionId(), saveAnonymousSessionSettings(), storeSessionId() (+4 more)
...
Cohesion: 0.20
Nodes (14): cacheKeyForName(), categoryTerms(), compactProduct(), cookingAdjectives, findProductForIngredient(), irregularCategoryTerms, normalizeIngredientKey(), NutritionWithSource (+6 more)
...
Cohesion: 0.18
Nodes (10): estimateIngredientNutrition(), gramsForIngredient(), IngredientNutritionEstimate, roundMacro(), totalNutritionFromEstimates(), RecipeOut, args, baseUrl (+2 more)
...
- **Why does `Random` connect `Community 6` to `Community 18`?**
