...
## Summary
- 2822 nodes · 5496 edges · 168 communities (156 shown, 12 thin omitted)
...
Cohesion: 0.09
Nodes (41): BudgetCard(), entryTotal(), ConfirmDialog(), AppButton(), Badge(), RecipeEditorOutput, Shell(), allSlots (+33 more)
...
Cohesion: 0.05
Nodes (87): BootstrapBoundary(), createEventBus(), EventBus, icsSubscriptionHints, isSubscriptionUrl(), IngredientEditor(), controls, PlanningPriorityControls() (+79 more)
...
Cohesion: 0.05
Nodes (46): Anonymous Session, API Change Checklist, API Contracts, Bootstrap, Canonical Scenario, code:ts (type DeadlineEndpoint =), code:ts (PlanningConstraints), code:json ({) (+38 more)
...
Cohesion: 0.12
Nodes (18): createDeadlineModeCommands(), DeadlineModeAction, DeadlineModeCommands, DeadlineModeInternalAction, deadlineModeReducer(), DeadlineModeState, initialDeadlineModeState, withEvent() (+10 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (31): currentItemKeys(), readStoredCheckedItems(), ShoppingListCard(), writeStoredCheckedItems(), fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl() (+23 more)
...
Cohesion: 0.12
Nodes (24): clamp(), countableUnits, formatIngredient(), ingredientAliases, ingredientName(), ingredientOptions, ingredientPreparations, ingredientSearchTerm() (+16 more)
...
Cohesion: 0.11
Nodes (23): AnalyticsProperties, AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, posthog, registerPostHogContext(), registerPostHogSession() (+15 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (44): minutesToTimeInputValue(), timeInputValueToMinutes(), blockMinutes(), buildCookingIcs(), buildCookingVEvent(), buildGoogleCalendarUrl(), buildShoppingGoogleCalendarUrl(), buildShoppingVEvent() (+36 more)
...
Cohesion: 0.07
Nodes (39): importFromSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent, ContextEventInput, DailyContext (+31 more)
...
Cohesion: 0.09
Nodes (26): prototypeMeta, calendarWarning, chilli, desktopNav, planDays, sessionLoaded, defaultDeadlines, initialPlan (+18 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (33): EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber(), RecipeEditor() (+25 more)
...
Cohesion: 0.25
Nodes (7): KitchenAccess, MealSlot, MealType, PlannedMeal, PrototypeMeta, RecipeDetails, ValidationResult
...
Cohesion: 0.13
Nodes (14): seededMeals, canonicalConstraints, deadlineBootstrap, constraints, expectedTotal, plan, ranked, rescued (+6 more)
...
Cohesion: 0.18
Nodes (11): AutoPlanResponse, buildAutoPlanContextEvents(), computePlanSignature(), contextEvents(), generateAutoPlan(), GenerateAutoPlanInput, base, changed (+3 more)
...
## Knowledge Gaps
- **1029 isolated node(s):** `database`, `location`, `rules`, `indexes`, `rules` (+1024 more)
...
- **Why does `sample_recipe()` connect `Community 82` to `Community 8`, `Community 26`?**
