...
## Corpus Check
- 226 files · ~352,760 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2597 nodes · 4763 edges · 153 communities (136 shown, 17 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `89b7d738`
...
Cohesion: 0.08
Nodes (43): BudgetCard(), entryTotal(), formatPortionNote(), allSlots, mealTypeIcon, priceDiff(), slotLabels, sortLabels (+35 more)
...
Cohesion: 0.07
Nodes (58): BootstrapBoundary(), createDeadlineModeCommands(), DeadlineModeCommands, DeadlineModeState, initialDeadlineModeState, createEventBus(), EventBus, BudgetSummary() (+50 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (49): firebaseFunctionUrl(), uploadRecipePhoto(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl() (+41 more)
...
Cohesion: 0.07
Nodes (38): defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber(), RecipeEditor() (+30 more)
...
Cohesion: 0.07
Nodes (46): icsSubscriptionHints, IngredientEditor(), ChoiceGroup(), Field(), SelectField(), UniversityField(), calendarWarning, chilli (+38 more)
...
Cohesion: 0.08
Nodes (33): ConfirmDialog(), AppButton(), appButtonClasses, AppButtonVariant, Badge(), badgeTones, Tone, RecipeEditorOutput (+25 more)
...
## Knowledge Gaps
- **1002 isolated node(s):** `indexes`, `fieldOverrides`, `database`, `location`, `rules` (+997 more)
...
- **Why does `RecipeIngredient` connect `Community 11` to `Community 48`, `Community 19`, `Community 20`, `Community 23`, `Community 153`, `Community 28`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 4` to `Community 65`, `Community 1`, `Community 153`, `Community 68`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 8` to `Community 63`, `Community 14`, `Community 79`?**
