...
## Corpus Check
- 137 files · ~76,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1339 nodes · 2345 edges · 98 communities (83 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee3df171`
...
Cohesion: 0.10
Nodes (35): icsSubscriptionHints, importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), fetchEvents(), GoogleEvent, importGoogleCalendar(), isGoogleConfigured() (+27 more)
...
Cohesion: 0.20
Nodes (18): appNodeEnv(), configuredBackend(), DeadlineEndpoint, fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames, firebaseFunctionsBaseUrl() (+10 more)
...
Cohesion: 0.14
Nodes (13): AppButton(), Shell(), AnalyticsProperties, TrackPrototypeEvent, DeadlineFoodPrototype(), isAppScreen(), onboardingScreens, screens (+5 more)
...
Cohesion: 0.12
Nodes (24): clamp(), countableUnits, createIngredientDraft(), formatQuantityForInput(), ingredientAliases, ingredientDraftsFromIngredients(), ingredientOptions, ingredientPreparations (+16 more)
...
Cohesion: 0.20
Nodes (9): APIs, code:ts#index.test.ts (import { test, expect } from "bun:test";), code:ts#index.ts (import index from "./index.html"), code:html#index.html (<html>), code:tsx#frontend.tsx (import React from "react";), code:sh (bun --hot ./index.ts), Frontend, graphify (+1 more)
...
Cohesion: 0.13
Nodes (21): IngredientEditor(), RecipeIngredient, formatIngredient(), IngredientDraft, sanitiseIngredientDrafts(), fetchOpenFoodFactsNutrition(), groceryVendorById(), MealType (+13 more)
...
Cohesion: 0.16
Nodes (12): sessionLoaded, defaultDeadlines, initialPlan, initialPreferences, mealSlots, createPrototypeSessionSettings(), restorePrototypePlan(), fallbackPlan (+4 more)

### Community 68 - "Community 68"
Cohesion: 0.21
Nodes (12): days, Deadline, classifyImportedEvent(), cookingEffortReason(), workloadLabel(), workloadScore(), CalendarScreen(), DeadlineEditPanel() (+4 more)
...
## Knowledge Gaps
- **624 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+619 more)
...
- **Why does `cn()` connect `Community 2` to `Community 19`, `Community 1`, `Community 35`, `Community 68`?**
...
- **Why does `Card()` connect `Community 2` to `Community 0`, `Community 1`, `Community 35`, `Community 49`, `Community 19`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.07515605493133583 - nodes in this community are weakly interconnected._
