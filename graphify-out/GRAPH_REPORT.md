...
## Summary
- 2491 nodes · 4529 edges · 149 communities (134 shown, 15 thin omitted)
...
Cohesion: 0.13
Nodes (15): DeadlineFoodApp(), isAppScreen(), onboardingScreens, replaceScreenUrl(), screens, urlForScreen(), setRecipeCatalogue(), CalendarToken (+7 more)
...
Cohesion: 0.16
Nodes (19): ClassifiedEvent, DailyContext, deadlineContextUrl(), deadlinesFromContext(), fetchDeadlineContext(), requestDeadlineContext(), resolveDeadlinesFromEvents(), calendarEventsToDeadlines() (+11 more)
...
Cohesion: 0.26
Nodes (11): firebaseFunctionUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), base64UrlEncode(), exchangeCodeOnServer(), generatePKCE(), importOutlookCalendar(), isOutlookConfigured() (+3 more)
...
Cohesion: 0.26
Nodes (7): importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), parseICSText(), unfoldLines(), CalendarProvider
...
## Knowledge Gaps
- **965 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+960 more)
