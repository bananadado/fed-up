...
## Corpus Check
- 179 files · ~111,115 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1968 nodes · 3835 edges · 125 communities (105 shown, 20 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5988bfc`
...
Cohesion: 0.11
Nodes (36): BudgetCard(), AppButton(), appButtonClasses, AppButtonVariant, Badge(), badgeTones, Tone, RecipeEditorOutput (+28 more)
...
Cohesion: 0.12
Nodes (27): icsSubscriptionHints, calendarEventsToDeadlines(), IngredientEditor(), ChoiceGroup(), Field(), SelectField(), UniversityField(), allergens (+19 more)
...
Cohesion: 0.09
Nodes (20): calendarWarning, desktopNav, sessionLoaded, defaultDeadlines, initialPlan, initialPreferences, seedMeals, DeadlineFoodPrototype() (+12 more)
...
## Knowledge Gaps
- **716 isolated node(s):** `database`, `location`, `rules`, `indexes`, `rules` (+711 more)
...
- **Why does `cn()` connect `Community 0` to `Community 11`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `recompute_user_profile()` connect `Community 1` to `Community 12`, `Community 38`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.08345577431677931 - nodes in this community are weakly interconnected._
