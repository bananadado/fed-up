...
## Corpus Check
- 218 files · ~156,844 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2544 nodes · 4624 edges · 151 communities (135 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e7862dba`
...
Cohesion: 0.08
Nodes (41): icsSubscriptionHints, IngredientEditor(), ChoiceGroup(), Field(), calendarWarning, chilli, desktopNav, planDays (+33 more)
...
Cohesion: 0.08
Nodes (52): BootstrapBoundary(), appButtonClasses, AppButtonVariant, badgeTones, SelectField(), Tone, UniversityField(), BudgetSummary() (+44 more)
...
Cohesion: 0.09
Nodes (22): Shell(), AnalyticsProperties, AutoPlanResponse, computePlanSignature(), contextEvents(), generateAutoPlan(), GenerateAutoPlanInput, DeadlineFoodPrototype() (+14 more)
...
Cohesion: 0.06
Nodes (58): GoogleIcon(), MicrosoftIcon(), AnalyticsProperty, capturePostHogEvent(), compactProperties(), host, posthog, registerPostHogContext() (+50 more)
...
Cohesion: 0.11
Nodes (15): seededMeals, canonicalConstraints, deadlineBootstrap, prototypeMeta, DeadlineBootstrap, PrototypeMeta, seedMeals, outdir (+7 more)
...
Cohesion: 0.40
Nodes (6): accountSessionDocId(), accountSessionHandle(), handleAccountSessionGet(), sendSessionJson(), sessionExpiryTimestamp(), timestampToIso()
...
## Knowledge Gaps
- **979 isolated node(s):** `firestore`, `firebaseAuth`, `prototypeRef`, `recipesRef`, `recipeReviewsRef` (+974 more)
...
- **Why does `recompute_user_profile()` connect `Community 2` to `Community 65`, `Community 75`, `Community 20`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `sample_recipe()` connect `Community 64` to `Community 65`, `Community 2`, `Community 58`, `Community 75`, `Community 26`?**
