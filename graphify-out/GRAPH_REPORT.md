...
## Corpus Check
- 141 files · ~84,154 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1479 nodes · 2592 edges · 91 communities (79 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a51230ef`
...
Cohesion: 0.08
Nodes (58): BootstrapBoundary(), createDeadlineModeCommands(), DeadlineModeCommands, createEventBus(), EventBus, appButtonClasses, AppButtonVariant, badgeTones (+50 more)
...
Cohesion: 0.13
Nodes (24): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), exchangeCodeOnServer() (+16 more)
...
Cohesion: 0.13
Nodes (23): formatIngredient(), ingredientKey(), recipeIngredients(), MealOption, MealType, PlannedMeal, RecipeDetails, ValidationResult (+15 more)
...
Cohesion: 0.10
Nodes (28): clamp(), countableUnits, createIngredientDraft(), formatIngredient(), formatQuantityForInput(), ingredientAliases, ingredientDraftsFromIngredients(), ingredientName() (+20 more)
...
Cohesion: 0.18
Nodes (23): BudgetCard(), Badge(), seedMeals, mealHealthSignals(), vegetableWords, weeklyBalanceSummary(), Meal, MealSlot (+15 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (37): icsSubscriptionHints, calendarEventsToDeadlines(), ChoiceGroup(), Shell(), sessionLoaded, allergens, calendarProviders, cookingAbilities (+29 more)
...
Cohesion: 0.11
Nodes (23): DeadlineModeAction, DeadlineModeInternalAction, deadlineModeReducer(), DeadlineModeState, initialDeadlineModeState, withEvent(), sortByPreferredFallback(), validateConstraints() (+15 more)
...
Cohesion: 0.12
Nodes (22): IngredientEditor(), AppButton(), Field(), RecipeIngredient, TrackPrototypeEvent, IngredientDraft, fetchOpenFoodFactsNutrition(), groceryVendorById() (+14 more)
...
Cohesion: 0.11
Nodes (23): minutesToTimeInputValue(), timeInputValueToMinutes(), days, classifyImportedEvent(), cookingEffortReason(), workloadLabel(), workloadScore(), CalendarScreen() (+15 more)
...
## Knowledge Gaps
- **648 isolated node(s):** `database`, `location`, `rules`, `indexes`, `port` (+643 more)
...
- **Why does `cn()` connect `Community 0` to `Community 44`, `Community 13`, `Community 14`, `Community 18`, `Community 23`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `RecipeIngredient` connect `Community 18` to `Community 5`, `Community 10`, `Community 13`, `Community 45`, `Community 23`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 0` to `Community 18`, `Community 13`, `Community 14`, `Community 23`?**
