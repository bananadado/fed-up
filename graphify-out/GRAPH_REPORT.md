...
## Corpus Check
- 238 files · ~383,673 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2933 nodes · 5857 edges · 163 communities (149 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 171 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21cb5213`
...
Cohesion: 0.08
Nodes (49): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, ShoppingListCard(), allSlots, mealTypeIcon, priceDiff() (+41 more)
...
Cohesion: 0.06
Nodes (60): icsSubscriptionHints, GoogleIcon(), MicrosoftIcon(), ChoiceGroup(), UniversityField(), AccountMessageTone, AccountProviderId, AccountSummary (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (47): IngredientEditor(), defaultForm(), EditorForm, formatPortionNote(), MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote() (+39 more)
...
Cohesion: 0.10
Nodes (31): seededMeals, canonicalConstraints, deadlineBootstrap, productMeta, formatIngredient(), ingredientKey(), recipeIngredients(), KitchenAccess (+23 more)
...
Cohesion: 0.13
Nodes (23): appButtonClasses, AppButtonVariant, badgeTones, Field(), SelectField(), Tone, Shell(), cn() (+15 more)
...
Cohesion: 0.11
Nodes (23): ConfirmDialog(), AppButton(), RecipeEditorOutput, scaleIngredients(), fetchRecipeReviews(), readJson(), RecipeReviewsResult, reviewsUrl() (+15 more)
...
Cohesion: 0.12
Nodes (16): Badge(), TrackEvent, Screen, AnalyticsProperties, AnalyticsProperty, capturePostHogEvent(), compactProperties(), host (+8 more)

### Community 157 - "Community 157"
Cohesion: 0.36
Nodes (8): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), fetchRecipeCatalogue()
...
- **Why does `RecipeIngredient` connect `Community 10` to `Community 5`, `Community 12`, `Community 46`, `Community 79`, `Community 18`, `Community 61`, `Community 29`?**
...
- **Why does `estimateRecipeCostPence()` connect `Community 54` to `Community 10`?**
