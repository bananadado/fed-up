...
## Summary
- 2812 nodes · 5155 edges · 155 communities (141 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7449870`
...
Cohesion: 0.06
Nodes (48): firebaseFunctionUrl(), importFromSubscriptionUrl(), isSubscriptionUrl(), normalizeWebcalUrl(), calendarFetchIcsUrl(), calendarGoogleExchangeUrl(), calendarOutlookExchangeUrl(), ClassifiedEvent (+40 more)
...
Cohesion: 0.06
Nodes (50): appNodeEnv(), configuredBackend(), DeadlineEndpoint, deadlineFoodEndpointUrl(), fetchCanonicalScenario(), fetchDeadlineBootstrap(), fetchSeededMeals(), firebaseFunctionNames (+42 more)
...
Cohesion: 0.06
Nodes (45): Shell(), defaultDeadlines, initialPlan, initialPreferences, seedMeals, DeadlineFoodApp(), DiscoverRecommendationRequest, isAppScreen() (+37 more)
...
Cohesion: 0.09
Nodes (42): BudgetCard(), entryTotal(), MealThumbnail(), MealThumbnailProps, formatPortionNote(), allSlots, mealTypeIcon, priceDiff() (+34 more)
...
Cohesion: 0.07
Nodes (42): sanitiseNumericInput(), defaultForm(), EditorForm, MEAL_SLOT_OPTIONS, MEAL_SLOT_SET, mealToForm(), parsePortionNote(), positiveNumber() (+34 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (34): ALLERGEN_ICONS, allergenIcon(), AllergenTag(), ConfirmDialog(), AppButton(), Badge(), RecipeEditorOutput, fetchRecipeReviews() (+26 more)
...
Cohesion: 0.12
Nodes (20): initFirebase(), IngredientNutritionEstimate, estimateStructuredPricePence(), authHeaders(), bulkUpsertRecipes(), listRecipes(), RecipeOut, recommenderUrl() (+12 more)
...
Cohesion: 0.40
Nodes (3): FirestoreMeal, Ingredient, Nutrition
...
## Knowledge Gaps
- **1083 isolated node(s):** `$schema`, `buildCommand`, `installCommand`, `outputDirectory`, `deploymentEnabled` (+1078 more)
...
- **Why does `RecipeIngredient` connect `Community 9` to `Community 64`, `Community 4`, `Community 5`, `Community 10`, `Community 11`, `Community 47`, `Community 80`, `Community 58`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `gramsForIngredient()` connect `Community 64` to `Community 101`, `Community 38`, `Community 80`, `Community 54`, `Community 61`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `sample_recipe()` connect `Community 31` to `Community 78`, `Community 2`, `Community 62`, `Community 30`?**
